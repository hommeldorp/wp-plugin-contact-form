...
1. Upload the plugin files to the `/wp-content/plugins/contact-slide-in-trigger` directory, or install the plugin through the WordPress plugins screen directly.
